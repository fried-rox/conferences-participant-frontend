  ...
  handleSubmit = async event => {
    ...
    try {
        const createParticipantObject = {
          ...
          parSuffix: this.state.parSuffix === "" ? undefined : this.state.parSuffix,
          ...
          mobilePhoneCode: this.state.mobilePhoneCode === "" ? undefined : this.state.mobilePhoneCode,
    ...
    return (
      <div className="NewPar">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <FormGroup controlId="parSuffix">
            <ControlLabel>Suffix</ControlLabel>
            <FormControl
              onChange={this.handleChange}
              value={this.state.parSuffix}
              type="text"/>
          </FormGroup>
          ...
          <FormGroup controlId="mobilePhoneCode">
            <ControlLabel>Mobile Phone Code</ControlLabel>
            <FormControl
              onChange={this.handleChange}
