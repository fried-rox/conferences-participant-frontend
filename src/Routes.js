...
export default ({ childProps }) =>
  <Switch>
    <AppliedRoute path="/view_profile" exact component={Dashboard} props={childProps} />
    <UnauthenticatedRoute path="/welcome" exact component={Login} props={childProps} />
    ...
    <AuthenticatedRoute path="/reviewabstract" exact component={Review} props={childProps} />
    { /* Finally, catch all unmatched routes */ }
    <Route component={NotFound} />
  </Switch>;


  // <AppliedRoute path="/:id" exact component={Home} props={childProps} />
